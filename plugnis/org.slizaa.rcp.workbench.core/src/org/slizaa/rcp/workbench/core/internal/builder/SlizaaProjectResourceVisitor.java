...
import org.slizaa.rcp.workbench.core.internal.projectconfig.SlizaaProjectConfigurationProblem;
...
public class SlizaaProjectResourceVisitor implements IResourceVisitor, IResourceDeltaVisitor {
  ...
  private boolean handleRemoved(IResourceDelta delta) throws CoreException {
